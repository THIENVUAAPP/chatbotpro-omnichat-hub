...
|---|---|---|
| Trang chủ/Landing page | Giới thiệu sản phẩm SaaS, bảng giá, CTA đăng ký | Public |
| Đăng ký tài khoản | Form đăng ký tenant mới, xác thực email/SĐT | Public |
| Đăng nhập | Đăng nhập bằng email/SĐT + mật khẩu, hỗ trợ SSO (Google) | Public |
| Quên mật khẩu / Đặt lại mật khẩu | Gửi OTP/link reset qua email | Public |
| Xác thực 2 lớp (2FA) | Cài đặt và xác minh 2FA qua app hoặc SMS | User đã đăng nhập |
...
| Dashboard theo nhân viên | Mỗi nhân viên xem hiệu suất cá nhân: số hội thoại đã xử lý, thời gian phản hồi trung bình | Agent (nhân viên CSKH) |
...
| Trang Lịch sử Webhook/Log tin nhắn lỗi | Theo dõi tin nhắn gửi/nhận thất bại, lỗi kết nối kênh để xử lý kỹ thuật | Admin, Dev |
...
| Trang | Mô tả chức năng | Vai trò truy cập |
|---|---|---|
| Quản lý sản phẩm/dịch vụ | Thêm/sửa/xóa, giá, hình ảnh, biến thể (size/màu), mô tả dùng cho bot tư vấn | Admin, Manager |
...
| Cài đặt thanh toán | Kết nối cổng thanh toán (VNPay, Momo, chuyển khoản), cấu hình COD | Admin |
...
| Chi tiết khách hàng | Lịch sử mua hàng, lịch sử chat toàn bộ kênh, ghi chú nội bộ, giá trị đơn trọn đời (LTV) | Admin, Manager, Agent |
...
| Trang | Mô tả chức năng | Vai trò truy cập |
|---|---|---|
| Thông tin doanh nghiệp | Tên, logo, địa chỉ, mã số thuế, ngành hàng | Admin |
...
| Quản lý Gói & Bảng giá Platform | Tạo/sửa các gói dịch vụ bán cho tenant (Free, Basic, Pro, Enterprise) | Super Admin |
| Quản lý Đối tác/Affiliate | Danh sách đối tác giới thiệu khách, theo dõi hoa hồng, lịch sử giới thiệu | Super Admin |
| Hồ sơ Đối tác | Thông tin đối tác, hợp đồng, gói hoa hồng đang áp dụng, link giới thiệu riêng | Super Admin, Đối tác (xem giới hạn) |
